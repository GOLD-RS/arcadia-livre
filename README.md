...
- `click-rush.html`, `virada-rapida.html`, `pixel-snake.html`, `conta-relampago.html`, `stack-neon.html`, `astro-dodge.html` — páginas individuais

Os arquivos dentro de `jogos/` são cópias antigas de trabalho e não devem ser publicados separadamente.

## Direitos e conteúdo

Os seis jogos e a interface foram desenvolvidos para este projeto. Não há arquivos SWF ou jogos de terceiros incluídos neste repositório.
