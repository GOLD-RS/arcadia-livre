...
const classic={click:'games-click.js',memory:'games-memory.js',snake:'games-snake.js',math:'games-math.js',stack:'games-stack.js',dodge:'games-dodge.js',pop:'games-pop.js',mole:'games-mole.js',color:'games-color.js',runner:'games-runner.js'};
...
for(const [key,page] of Object.entries(expected)){
 ...
 if(classic[key]){
  ...
  const legacyTitle={click:"title.textContent='Click Rush'",memory:"title.textContent='Virada Rápida'",snake:"title.textContent='Pixel Snake'",math:"title.textContent='Conta Relâmpago'",stack:"title.textContent='Stack Neon'",dodge:"title.textContent='Astro Dodge'",pop:"title.textContent='Bubble Pop'",mole:"title.textContent='Pixel Mole'",color:"title.textContent='Color Circuit'",runner:"title.textContent='Sky Runner'"}[key];
